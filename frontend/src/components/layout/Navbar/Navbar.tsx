...
export const Navbar: React.FC = () => {
  ...
  // Actually, our RootLayout wraps everything, so we can safely use useTheme here
          ...
          <>
            ...
            <div className={styles.appActions}>
              ...
              <button
                ...
                onClick={() => window.location.assign('/settings?tab=notifications')}
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className={styles.hamburgerWrapper} ref={menuRef}>
                ...
                >
                  <ul className={styles.menuList}>
                    ...
                    {isAdmin && (
                      <li key="admin" className={styles.menuItem}>
                        <Link
                          href="/admin"
                          className={`${styles.menuLink} ${pathname.startsWith('/admin') ? styles.menuLinkActive : ''}`}
                          onClick={() => setMenuOpen(false)}
                        >
                          ...
                          <span className={styles.menuLabel}>Admin</span>
                        </Link>
                      </li>
                    )}
                  </ul>
